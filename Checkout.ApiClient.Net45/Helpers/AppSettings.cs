...
namespace Checkout
{
    ...
    public sealed class AppSettings
    {
        ...
        private static string _shoppingUri;

        public static string ShoppingUri
        {
            get { return _shoppingUri ?? (_shoppingUri = ReadConfig("ShoppingCart.Uri", true)); }
            set { _shoppingUri = value; }
